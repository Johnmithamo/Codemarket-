...
export default function SellerDashboard() {
  ...
  try {
    await axios.put(`https://movie-nova-4.onrender.com/user/services/${id}`, {
  ...
  axios.get("https://movie-nova-4.onrender.com/profile", { headers })
  .then(res => {
  ...
  // Fetch services
  axios.get("https://movie-nova-4.onrender.com/my/services", { headers })
  ...
  // Fetch orders
  axios.get("https://movie-nova-4.onrender.com/user/orders", {
  ...
  // Fetch transactions
  axios.get("https://movie-nova-4.onrender.com/user/transactions", {
    headers: { Authorization: `Bearer ${token}` }
  })
  ...
  // Fetch reviews
  axios.get("https://movie-nova-4.onrender.com/user/reviews", {
    headers: { Authorization: `Bearer ${token}` }
  })
